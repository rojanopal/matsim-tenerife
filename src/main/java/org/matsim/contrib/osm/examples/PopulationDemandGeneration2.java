...
public class PopulationDemandGeneration2 {
    ...
    public static void main(String[] args) {
        ...
        CoordinateTransformation ct =
                TransformationFactory.getCoordinateTransformation(TransformationFactory.WGS84, TransformationFactory.WGS84_UTM29N);
         ...
         */
        Coord homeCoordinates = new Coord(28.0491658, -16.5589778);
        ...
        popWriter.write("plans/population6.xml");
    }
